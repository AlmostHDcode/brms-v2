<?php
    session_start();
    //if session doesn't exist go back to index page
    ...
    //if session exists but userlevel is 0 redirect back to buildings page
    //only applicable for admin only pages
